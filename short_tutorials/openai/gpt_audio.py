#!/usr/bin/env uv run
####################################################################
#  SOURCE: https://github.com/openai/openai-python/blob/main/examples/realtime/push_to_talk_app.py
####################################################################
...
from gpt_audio_util import CHANNELS, SAMPLE_RATE, AudioPlayerAsync
